            ...
            try
            {
                ...
                using (MySqlConnection conexion = new MySqlConnection(cadenaConexion))//pasando un objeto de la conexion hacia MySql
                {
                    ...
                    using (MySqlCommand comando = new MySqlCommand(sql.ToString(), conexion))
                    {
                        ...
                        comando.Parameters.Add("@Description", MySqlDbType.VarChar, 200).Value = item.description;
            ...
            try
            {
                ...
                using (MySqlConnection conexion = new MySqlConnection(cadenaConexion))//pasando un objeto de la conexion hacia MySql
                {
                    ...
                    using (MySqlCommand comando = new MySqlCommand(sql.ToString(), conexion))
                    {
                        ...
                        comando.Parameters.Add("@Description", MySqlDbType.VarChar, 200).Value = productFromDB.description;
